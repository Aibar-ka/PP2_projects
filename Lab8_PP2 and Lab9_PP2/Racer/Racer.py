...
class Player(pygame.sprite.Sprite):
    ...
    def move(self):  # machine movement function
        ...
        if keys[
            pygame.K_w] and self.rect.top > 0:  # the condition when the up button is pressed and the car is not located on the upper border of the screen
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.images = [pygame.image.load(r'coin.png'),]
        self.supcoin()
...
while running:  # start of the cycle
    ...
    screen.fill(WHITE)
    screen.blit(pygame.transform.scale(road, (WIDTH, HEIGHT)),
                (0, 0 % HEIGHT))  # stretching an image to fit the screen
